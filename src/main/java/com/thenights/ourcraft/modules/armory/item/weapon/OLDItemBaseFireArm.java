...
// */
//package com.thenights.ourcraft.armory.item.weapon;
//
...
//import com.thenights.ourcraft.armory.item.OurcraftArmoryItems;
//import com.thenights.ourcraft.armory.item.material.ArmoryRangedMaterial;
//import com.thenights.ourcraft.armory.item.ItemTagsArmory;
...
// * @author Stephanie
// */
//public class OLDItemBaseFireArm extends ShootableItem {
//
...
//
//    public OLDItemBaseFireArm(ArmoryRangedMaterial rangedspecs, Properties props) {
...
//        int reloadtime = 25;
//        if (stack.getItem() instanceof OLDItemBaseFireArm) {
//            OLDItemBaseFireArm firearm = (OLDItemBaseFireArm) stack.getItem();
...
//        int projectiles = 1;
//        float spread = 0.0f;
//        if (weapon.getItem() instanceof OLDItemBaseFireArm) {
//            OLDItemBaseFireArm firearm = (OLDItemBaseFireArm) weapon.getItem();
...
//            if (p_220016_3_.getItem() instanceof OLDItemBaseFireArm) {
//                OLDItemBaseFireArm firearm = (OLDItemBaseFireArm) p_220016_3_.getItem();

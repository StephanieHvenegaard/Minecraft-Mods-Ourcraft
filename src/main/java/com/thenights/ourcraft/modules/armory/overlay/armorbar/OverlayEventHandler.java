...
import static com.thenights.ourcraft.armory.core.Configs.alwaysShowArmorBar;
import static com.thenights.ourcraft.armory.core.Configs.showEmptyArmorIcons;
import static com.thenights.ourcraft.armory.core.Configs.offset;
...
public class OverlayEventHandler {
    ...
    public void renderArmorBar(int screenWidth, int screenHeight) {
        ...
        if (currentArmorValue != previousArmorValue) {
            //Calculate here
            armorIcons = ArmorBar.calculateArmorIconsBase10(currentArmorValue);
    ...
    public void forceUpdate() {
        ...
        ArmoryClientProxy.handler.previousArmorValue = UNKNOWN_ARMOR_VALUE;
    }
}
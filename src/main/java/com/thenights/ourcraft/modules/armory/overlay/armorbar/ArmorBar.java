//package com.thenights.ourcraft.armory.overlay.armorbar;
//
...
//{
//    private static int scaler = 10; // 20;
//
...
//        // OurcraftArmory.LOGGER.info("currentArmorValue :"+ colors);
...
//    }
//
//    public static ArmorIcon[] calculateArmorIconsBase20(int playerArmorValue)
//    {
...
//            setArmorIconColor(armorIcons[i], Lists.newArrayList("#A03500", "#FFFFFF", "#FFC747", "#27FFE3", "#00FF00", "#7F00FF"), scale, counter);
//            if (counter >= 2)
//            {
...
//        return armorIcons;
//    }
//    public static ArmorIcon[] calculateArmorIconsBase10(int playerArmorValue)
//    {
//        ArmorIcon[] armorIcons = new ArmorIcon[10];
//
//        //Calculate which color scale to use
//        int scale = playerArmorValue / 10;
//
//        //Scale the value down for each position
//        int counter = playerArmorValue - (scale * 10);
//
//        //Handle exact wrap around situation
//        if(scale > 0 && counter == 0)
//        {
...
//        {
//            armorIcons[i] = new ArmorIcon();
//            setArmorIconColor(armorIcons[i], Lists.newArrayList("#FFFFFF", "#27FFE3", "#45008E"), scale, counter);
//            if (counter >= 1)
//            {
//                    armorIcons[i].armorIconType = ArmorIcon.Type.FULL;
//                    counter -= 1;

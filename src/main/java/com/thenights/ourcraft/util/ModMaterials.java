...
public class ModMaterials {
    ...
    public static final ItemArmor.ArmorMaterial OBSIDIAN_ARMOR = EnumHelper.addArmorMaterial( "obsidian", Ourcraft.RESOURCE_PREFIX+"obsidian", 330, new int[] { 10, 12, 9, 7 }, 3, SoundEvents.ITEM_ARMOR_EQUIP_GENERIC, 4.0F).setRepairItem(new ItemStack(ModItems.OBSIDIAN_INGOT_ITEM));
    public static final Item.ToolMaterial OBSIDIAN = EnumHelper.addToolMaterial("obsidian", 3, (int)(1562*3.5), 8.0F, 3.0F, 3).setRepairItem(new ItemStack(ModItems.OBSIDIAN_INGOT_ITEM));
}
